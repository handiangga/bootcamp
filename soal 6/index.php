    ...
    <div class="container-fluid mt-5">
        <div class="row justify-content-center">
            <div class="col-sm-6 bg-light py-4" style="border-radius: 10px;">
				...
				<?php
					require 'conn.php';
					$query = mysqli_query($conn, "SELECT * FROM work JOIN nama  ON work.id_work=nama.id_work JOIN kategori ON nama.id_salary=kategori.id_salary   ORDER BY id_nama") or die(mysqli_error());
					while($fetch = mysqli_fetch_array($query)){
				?>
				<tr>
					<td><?php echo $fetch['nama']?></td>
					<td><?php echo $fetch['nama_work']?></td>
					<td><?php echo $fetch['salary']?></td>
					<td>
					<a class="btn btn-danger btn-flat btn-xs" data-toggle="modal" data-target="#delete_user<?php echo $fetch['id_nama']?>"><i class="fa fa-trash"></i></a>
					<a class="btn btn-primary btn-flat btn-xs" data-toggle="modal" data-target="#update_modal<?php echo $fetch['id_nama']?>"><i class="fa fa-edit"></i></a>
						...
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								<select name="salary" class="form-control">
									<?php
										$sql_kategori = mysqli_query($conn, "SELECT * FROM kategori") or die (mysqli_error());
